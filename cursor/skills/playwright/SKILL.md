---
name: playwright
description: "Use when the task requires automating a real browser from the terminal through Playwright CLI: navigation, form filling, snapshots, screenshots, data extraction, UI-flow debugging, or local web app inspection via the bundled `.cursor/skills/playwright/scripts/playwright_cli.sh` wrapper."
---

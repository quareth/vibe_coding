...
Template for `.claude/state/implementation-review-state.md`. This file is a current-cycle blocker ledger, not long-term review memory.

Copy the clean YAML block into `.claude/state/implementation-review-state.md` when starting a review loop. Keep `.claude/state/implementation-state.md` as the source of truth for guide, phase, task, intent, and ownership checklist.
...
implementation_state: ".claude/state/implementation-state.md"

...
- **Match the repo**: Align with CLAUDE.md, existing architecture, wired paths, safety boundaries, and naming conventions discovered in the repository. Do not invent patterns that contradict the codebase.

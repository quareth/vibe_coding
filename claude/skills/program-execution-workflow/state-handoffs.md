...
All state paths are under `.claude/agents/`.
...
review round ← 0
review implementation_state ← .claude/state/implementation-state.md
...
quality implementation_state ← .claude/state/implementation-state.md
quality round ← 0
...
This file is authoritative for Claude Code program-workflow handoffs.

...
description: Run a repository-local state-driven implementation review loop through `.codex/agents/implementation-review-state.md`. Use when the user asks to review current implementation work, review a phase or task, run final implementation review, run review-and-fix until no blockers, or mentions implementation-review-state, blocker ledger, reviewer/fixer loop, or fresh full review.
---

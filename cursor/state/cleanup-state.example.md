...
Template for `.cursor/state/cleanup-state.md`. Copy the YAML block into that file between `---` delimiters when starting a new cleanup campaign or resetting state.

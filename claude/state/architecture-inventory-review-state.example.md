...
Template for `.claude/state/architecture-inventory-review-state.md`.
...
round: 0
max_rounds: 20
architecture_state: ".claude/state/architecture-documentation-state.md"
...
active_findings:
  - id: "INV-R1-P1"
    ...
    evidence:
      ...
      docs:
        - "CLAUDE.md lists prompt management as a high-signal entrypoint."

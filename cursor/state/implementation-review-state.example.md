...
Template for `.cursor/state/implementation-review-state.md`. This file is a current-cycle blocker ledger, not long-term review memory.

Copy the clean YAML block into `.cursor/state/implementation-review-state.md` when starting a review loop. Keep `.cursor/state/implementation-state.md` as the source of truth for guide, phase, task, intent, and ownership checklist.
...
implementation_state: ".cursor/state/implementation-state.md"

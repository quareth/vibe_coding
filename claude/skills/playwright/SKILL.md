---
name: playwright
description: "Use when the task requires automating a real browser from the terminal through Playwright CLI: navigation, form filling, snapshots, screenshots, data extraction, UI-flow debugging, or local web app inspection via the bundled `.claude/skills/playwright/scripts/playwright_cli.sh` wrapper."
---
...
```bash
export PWCLI=".claude/skills/playwright/scripts/playwright_cli.sh"
```

If the skill is installed personally under `~/.claude/skills/playwright/`:

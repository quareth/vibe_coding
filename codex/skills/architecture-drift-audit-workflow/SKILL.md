...
description: Run a scheduled repository-local architecture documentation drift audit through `.codex/agents/architecture-documentation-state.md`. Use when the user asks to verify architecture docs against current code, run a periodic architecture audit, check for documentation drift, update drifted architecture docs, or keep `docs/architecture/*` aligned with code.
---
